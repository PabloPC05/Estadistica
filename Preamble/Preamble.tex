...
% \input{Preamble} % Ensure the Preamble.tex file exists or comment this line out if not needed
...
% Definir colores
\definecolor{LightPurple}{rgb}{0.9, 0.8, 1}  % Lila claro
\definecolor{White}{rgb}{1, 1, 1}            % Blanco
...
% Definir estilo para el enunciado del ejercicio
\declaretheoremstyle[
    headfont=\bfseries,
    notebraces={[}{]},
    bodyfont=\normalfont,
...
% Definir estilo para la solución
\declaretheoremstyle[
    headfont=\bfseries,
    notebraces={[}{]},
    bodyfont=\normalfont\itshape,
...
% Definir los entornos de ejercicio y solución
\declaretheorem[style=EjercicioStyle, numbered=yes]{ejercicio}
\declaretheorem[style=SolucionStyle, numbered=no]{solucion}
...
\newenvironment{problem}[2][Ejercicio]{\begin{trivlist}
